...
В проекте используется библиотека python-dotenv, чтобы хранить конфиденциальные данные, такие как настройки для подключения к базе данных и секретный ключ.
